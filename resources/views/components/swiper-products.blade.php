...
<div class="w-full relative">
    <div id="skeleton-slider-{{$swiperClass}}" class="flex w-full relative mb-10 h-101 2xs:h-112 1xs:h-128 xs:h-99 sm:h-126 md:h-60 lg:h-68">
        <!-- Skeleton screen -->
        <div class="grid grid-cols-2 xs:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-1 1xs:gap-x-6 xs:gap-x-2.5 md:gap-x-1 lg:gap-x-4 gap-y-1 w-96 1xs:w-152 xs:w-110.75 sm:w-152 md:w-184 lg:w-238 xl:w-257">
            @for($i=0; $i<=3; $i++)
