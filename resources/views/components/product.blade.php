...
{{--            <x-heart-button class="border" iClass="text-gray-300 self-center hover:text-orange-500 transition duration-300 ease-in"/>--}}
            <a href="{{route('subdomain.leaflet', ['subdomain'=> $shop_slug, 'data' => $leaflet_valid_from,'id' => $leaflet_id ])}}#{{$page_number}}" class="opacity-0 absolute top-0 left-0 right-0 bottom-0 flex justify-center bg-blue-550 rounded border border-blue-550 transition duration-500 hover:opacity-100">
...
{{--                            <x-heart-button class="border" iClass="text-blue-550 self-center hover:text-orange-500 transition duration-300 ease-in"/>--}}
        ...
        <a href="{{route('subdomain.leaflet', ['subdomain'=> $shop_slug, 'data' => $leaflet_valid_from,'id' => $leaflet_id ])}}#{{$page_number}}" >
            <div class="flex">
