...
return [
    ...
    'defaults' => [
        ...
        'main_leaflets_category' => [
            'default' => [
                'meta_title' => "Gazetki promocyjne • {category} • GazetkaPromocyjna.com.pl",
        ...
        'subdomain_leaflet' => [
            'default' => [
                'meta_title' => "Gazetka 🔥 {title} w {shop} od {valid_from} | GazetkaPromocyjna.com.pl",
                ...
                'meta_keywords' => "{category}, gazetki",
                'h1_title' => "Gazetka promocyjna {title} {shop} od {valid_from} do {valid_to}",
