...
return [
    'slots' => [
        'homepage_header' => [
            ...
            'targeting' => [
                'page' => 'top',  // ← dynamiczne pole, może być nadpisane
            ],
            'adsense_fallback' => [
            ...
            'refresh_interval' => 300, // sekundy nie mniej niż 30s.
        ],
        'homepage_middle_1' => [
            ...
            'priority' => 'gam',
            'targeting' => [
                'position' => 'middle_1',  // ← dynamiczne pole, może być nadpisane
            ],
            'adsense_fallback' => [
                'client' => 'ca-pub-0504184268109752',
                'slot'   => '8461649229',
        ...
        'homepage_sidebar_left' => [
            ...
            'priority' => 'gam',
            'targeting' => [
                'page' => 'left',  // ← dynamiczne pole, może być nadpisane
            ],
            'adsense_fallback' => [
                'client' => 'ca-pub-0504184268109752',
                'slot'   => '5086382053',
        ...
        'subdomain_middle_mobile_1' => [
            'slot' => '/7894359647/gp_subdomain_page_middle_mobile_1_gam',
            'div_id' => 'subdomain_middle_mobile_1',
            'mapping' => [
                [
                    'viewport' => [640, 0],
                    'sizes' => [[0, 0]],
        ...
        'subdomain_middle_mobile_2' => [
            'slot' => '/7894359647/gp_subdomain_page_middle_mobile_2_gam',
            'div_id' => 'subdomain_middle_mobile_2',
            'mapping' => [
                [
                    'viewport' => [640, 0],
                    'sizes' => [[0, 0]],
            ...
            'priority' => 'gam', // gam lub adsense
            'targeting' => [
                'page' => 'adsense',  // ← dynamiczne pole, może być nadpisane
            ],
            'adsense_fallback' => [
                'client' => 'ca-pub-0504184268109752',
                'slot'   => '7982319809',
        ...
        'subdomain_middle_desktop_1' => [
            'slot' => '/7894359647/gp_subdomain_page_middle_desktop_1_gam',
            'div_id' => 'subdomain_middle_desktop_1',
            'mapping' => [
                [
                    'viewport' => [1024, 0],
                    'sizes' => [[0, 0]],
        ...
        'subdomain_middle_desktop_2' => [
            'slot' => '/7894359647/gp_subdomain_page_middle_desktop_2_gam',
        ...
        'subdomain_middle_desktop_3' => [
            ...
            'div_id' => 'subdomain_middle_desktop_3',
            'mapping' => [
                [
                    'viewport' => [768, 0],
                    'sizes' => [[750, 300]],
